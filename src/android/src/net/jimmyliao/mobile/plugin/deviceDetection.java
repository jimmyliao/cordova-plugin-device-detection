...
import net.jimmyliao.mobile.plugin.Root;

public class deviceDetection extends CordovaPlugin {

  private static final String ACTION_CHECK_ROOT = "isRoot";
  private static final String ACTION_CHECK_JAILBREAK = "isJailBreak";
...
//    else if(ACTION_CHECK_JAILBREAK.equals(action)) {
//    	callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, result));
//    	resultStatus = true;
//    }
    else {
    	callbackContext.error("deviceDection." + action + " is not a supported function. Did you mean '" + ACTION_CHECK_ROOT + "'?");
